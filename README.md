...
What's inside
SkillCategoryWhat it doessession-health-diagnostic-advisorSession managementMonitors token spend and context bloat during long sessions. Tells you when to run /cost, /compact, or /clear.
...
Contributing
PRs welcome. Keep skills focused — one purpose per skill — and include a brief README explaining when to use it. See CONTRIBUTING.md.
License
